...
interface ToolFilterInterface {
	genreId?: number
	onGenreChange: (genreId: number | undefined) => void,
	keySearch?: string;
	onKeySearchChange: (keySearch: string) => void;
}

const ToolFilter: React.FC<ToolFilterInterface> = (props) => {

	//Tạo biến để lưu trữ giá trị tìm kiếm
	const [keySearchTemp, setKeySearchTemp] = useState<string>(props.keySearch ?? "");
